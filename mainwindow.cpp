    ...
    ui(new Ui::MainWindow)
{
   ...
   // ui->lcdNumber_speed->setPalette(pal);
    ...
    pix1.load("://images//iii//hook3.png");//设置钩子，60*50
    pix2.load("://images//iii//hook3.png");
...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    if((miner1->isrotating()==false||miner1->isstopped())||(miner2->isrotating()==false||miner2->isstopped()))
    {
        if((miner1->isrotating()==false||miner1->isstopped())&&miner2->isrotating())
        {
            ...
            painter.drawLine(250,95,250-length1*sin(miner1->get_angle()/rad),95+length1*cos(miner1->get_angle()/rad));
            ...
            painter.drawLine(450,95,450-20*sin(miner2->get_angle()/rad),95+20*cos(miner2->get_angle()/rad));
        ...
        if((miner2->isrotating()==false||miner2->isstopped())&&miner1->isrotating())
        {
            ...
            painter.setPen(pen2);
            painter.setRenderHint(QPainter::Antialiasing, true);
            painter.drawLine(450,95,450-length2*sin(miner2->get_angle()/rad),95+length2*cos(miner2->get_angle()/rad));
            ...
            painter.drawLine(250,95,250-20*sin(miner1->get_angle()/rad),95+20*cos(miner1->get_angle()/rad));
